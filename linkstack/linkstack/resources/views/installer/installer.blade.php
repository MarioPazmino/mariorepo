...
@if(!isset($_SERVER['QUERY_STRING']) || $_SERVER['QUERY_STRING'] === '')
    <!-- Aquí va el código que quieres ejecutar cuando no hay query string -->
...
@if(isset($_SERVER['QUERY_STRING']) && $_SERVER['QUERY_STRING'] === '2')
{{-- Landing page --}}
...
@if(isset($_SERVER['QUERY_STRING']) && $_SERVER['QUERY_STRING'] === '3')
{{-- Landing page --}}
...
@if(isset($_SERVER['QUERY_STRING']) && $_SERVER['QUERY_STRING'] === 'mysql')
{{-- Landing page --}}
...
@if(isset($_SERVER['QUERY_STRING']) && $_SERVER['QUERY_STRING'] === '4')
{{-- Landing page --}}
...
@if(isset($_SERVER['QUERY_STRING']) && $_SERVER['QUERY_STRING'] === '5')
{{-- Landing page --}}
